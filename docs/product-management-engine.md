...
Scoring uses priority, carry-over from the previous cycle, next-cycle assignment, stale age, ownership, and high-signal labels such as `security`, `incident`, `customer`, and `revenue`.
